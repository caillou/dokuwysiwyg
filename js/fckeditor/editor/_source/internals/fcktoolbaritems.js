...
FCKToolbarItems.GetItem = function( itemName )
{
	...
	switch ( itemName )
	{
		...
		case 'Monospace'		: oItem = new FCKToolbarButton( 'Monospace'	, FCKLang.Monospace, null, null, false, true, 74 ) ; break ;
		case 'Footnote'	    	: oItem = new FCKToolbarButton( 'Footnote'	, FCKLang.Footnote, null, null, false, true, 75 ) ; break ;
